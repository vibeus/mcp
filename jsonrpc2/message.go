...
// ID is a request/response identifier. It can be either a string or an integer.
// It is unique within a single session and automatically generated by the client.
//   - implements [pkg/encoding/json.Unmarshaler].
//   - implements [pkg/encoding/json.Marshaler].
type ID struct {
	name   string
	number int32
}
...
// ErrorObject represents an error object returned by the server.
...
// RPCError represents an error that occurred during the protocol. It wraps
// another error to provide additional context.
